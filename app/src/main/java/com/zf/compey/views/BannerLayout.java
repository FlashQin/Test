...
public class BannerLayout extends RelativeLayout {
    ...
    private static class SavedState extends BaseSavedState {
        ...
        public static final Creator<SavedState> CREATOR = new Creator<BannerLayout.SavedState>() {
            @Override
            public BannerLayout.SavedState createFromParcel(Parcel in) {
                return new BannerLayout.SavedState(in);
            }

            @Override
            public BannerLayout.SavedState[] newArray(int size) {
                return new BannerLayout.SavedState[size];
            }
        };
    }
